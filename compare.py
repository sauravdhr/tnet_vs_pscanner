...
def compare_tnet(folders):
	TP_FP_FN_file = open('SEIR01.tnet.80.TP_FP_FN.csv', 'w+')
	TP_FP_FN_file.write('dataset,tnet_tp,tnet_fp,tnet_fn,tnet_mul_tp,tnet_mul_fp,tnet_mul_fn,tnet_boot_tp,tnet_boot_fp,tnet_boot_fn\n')
	F1_file = open('SEIR01.tnet.80.F1.csv', 'w+')
	F1_file.write('dataset,tnet_prec,tnet_rec,tnet_f1,tnet_mul_prec,tnet_mul_rec,tnet_mul_f1,tnet_boot_prec,tnet_boot_rec,tnet_boot_f1\n')
	...
	for folder in folders:
		...
		# print(TP_FP_FN)
		# print(F1)
		TP_FP_FN_file.write('{},{},{},{},{},{},{},{},{},{}\n'.format(folder,TP_FP_FN[0],TP_FP_FN[1],TP_FP_FN[2],TP_FP_FN[3],TP_FP_FN[4],
									TP_FP_FN[5],TP_FP_FN[6],TP_FP_FN[7],TP_FP_FN[8]))
